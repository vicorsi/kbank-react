                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'text-gray-800 font-semibold' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      {localStorage.session == 'logged' && <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'bg-red-500 block px-4 py-2 text-sm text-white')}
                          >
                            Entrar
                          </a>
                        )}
